...
//   }
  ...
  if ((A[A.length] + (A[A.length] - middle_pos[middle_pos.length])) < domain[1]) {
      middle_pos.push(A[A.length] + (A[A.length] - middle_pos[middle_pos.length]))
  }
  return middle_pos
  }
